...
if __name__ == '__main__':
  ...
  if len(sys.argv) != 4:
    ...
    print("The first argument should be a directory containing a set of subdirectories representing class names. Each subdirectory should contain PNG or PNG encoded images.")
